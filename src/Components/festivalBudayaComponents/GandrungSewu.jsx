            ...
            <div className="gandrung">
                ...
                <div className="col-buttom">
                    ...
                    <div className="bottom-text-left">
                        <p>Festival Tari Gandrung Sewu di Banyuwangi adalah persembahan tarian tradisional yang megah dan memukau.</p>
                    </div>
                </div>
                <div className="col-very-bottom">
                    <p>Dikenal sebagai "Sewu" yang berarti seribu, festival ini menampilkan ribuan penari Gandrung dalam harmoni gerakan yang memesona.</p>
                </div>
            </div>
        </>
    )
