    ...
    return(<>
        <footer>
            ...
            <div className="left-container">
                <div className="l-top">
                   <div className="left">
                        <a href="">Info Lebih Lanjut <Gmaterial name="navigate_next"/></a>
                   </div>
                   <div className="right">
                        <div className="con">
                            <p>Ikuti sosial media kami</p>
                            <div className="linked">
                                <a href=""><img src={iGoogle} alt="image" /></a>
                                <a href=""><img src={iYoutube} alt="image" /></a>
                                <a href=""><img src={iFacebook} alt="image" /></a>
                                <a href=""><img src={iInstagram} alt="image" /></a>
